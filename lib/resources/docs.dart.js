(function dartProgram() {
  ...
  var J = {
      ...
      ev(a) {
        ...
        if (n != null) {
          ...
          if (s === r) return n.i;
          if (n.e === r)
            throw A.b(A.eZ("Return interceptor for " + A.i(s(a, n))));
        }
        q = a.constructor;
        if (q == null) p = null;
        else {
      ...
      hv(a, b) {
        if (a < 0 || a > 4294967295)
          throw A.b(A.E(a, 0, 4294967295, "length", null));
        return J.hx(new Array(a), b);
      },
      hw(a, b) {
        if (a < 0)
          throw A.b(A.V("Length must be a non-negative integer: " + a, null));
      ...
      ah(a) {
        ...
        if (typeof a != "object") {
          if (typeof a == "function") return J.Y.prototype;
      ...
      h5(a, b) {
        if (typeof b === "number")
          if (
            Array.isArray(a) ||
            typeof a == "string" ||
            A.jA(a, a[v.dispatchPropertyName])
          )
    ...
    A = {
      e1: function e1() {},
      hc(a, b, c) {
        if (t.U.b(a)) return new A.b5(a, b.j("@<0>").C(c).j("b5<1,2>"));
      ...
      bk: function bk() {},
      hi() {
        throw A.b(A.cJ("Cannot modify unmodifiable Map"));
      },
      fP(a) {
      ...
      jh(a) {
        return new A.G(!0, a, null, null);
      },
      b(a) {
        return A.x(a, new Error());
      },
      x(a, b) {
        var s;
        if (a == null) a = new A.Q();
      ...
      ez(a, b) {
        throw A.x(a, b == null ? new Error() : b);
      },
      aD(a, b, c) {
        var s;
        if (b == null) b = 0;
      ...
      jg(a) {
        ...
        if ("number" in a && typeof a.number == "number") {
          r = a.number;
          q = r & 65535;
          if ((B.c.aa(r, 16) & 8191) === 10)
            switch (q) {
              case 438:
                return A.a6(a, A.e2(A.i(s) + " (Error " + q + ")", null));
              case 445:
              case 5007:
                A.i(s);
                return A.a6(a, new A.aZ());
            }
        }
        if (a instanceof TypeError) {
          ...
          return A.a6(a, new A.bU(typeof s == "string" ? s : ""));
        }
      ...
      iU(a, b, c, d, e, f) {
        ...
        throw A.b(
          new A.cY("Unsupported number of arguments for wrapped closure"),
        );
      },
      az(a, b) {
        var s = a.$identity;
      ...
      hh(a2) {
        ...
        s = h
          ...
          : Object.create(new A.aF(null, null).constructor.prototype);
      ...
      hf(a, b, c, d) {
        ...
        switch (b ? -1 : a) {
          case 0:
            throw A.b(new A.bS("Intercepted function with no arguments."));
          case 1:
      ...
      ha(a, b) {
        return A.bg(v.typeUniverse, A.aB(a.a), b);
      },
      eI(a) {
        return a.a;
      },
      ...
      eF(a) {
        var s,
          r,
          q,
          p = new A.aF("receiver", "interceptor"),
        ...
        throw A.b(A.V("Field name " + a + " not found.", null));
      },
      jr(a) {
      ...
      jw() {
        ...
        m = A.ay(
          ...
          A.ay(
            B.r,
            A.ay(B.l, A.ay(B.l, A.ay(B.t, A.ay(B.u, A.ay(B.v(B.k), m))))),
          ),
        );
      ...
      ae(a, b, c) {
        if (a >>> 0 !== a || a >= c) throw A.b(A.fJ(b, a));
      },
      iE(a, b, c) {
        var s;
      ...
      ce(a) {
        return A.dl(v.typeUniverse, a, !1);
      },
      af(a1, a2, a3, a4) {
        var s,
          r,
        ...
        switch (a0) {
          ...
          default:
            throw A.b(
              A.br("Attempted to substitute unexpected RTI kind " + a0),
            );
        }
      },
      ax(a, b, c, d) {
      ...
      fI(a) {
        var s = a.$S;
        if (s != null) {
          if (typeof s == "number") return A.jt(s);
          return a.$S();
        }
        return null;
      },
      ...
      aB(a) {
        if (a instanceof A.j) return A.T(a);
      ...
      K(a) {
        return A.ag(A.dl(v.typeUniverse, a, !1));
      },
      iP(a) {
        var s,
          r,
      ...
      fs(a, b) {
        return new A.bc("TypeError: " + A.f2(a, A.D(b, null)));
      },
      f2(a, b) {
        return (
          A.cn(a) +
      ...
      M(a, b) {
        return new A.bc("TypeError: " + A.f2(a, b));
      },
      iV(a) {
        var s = this;
      ...
      D(a, b) {
        ...
        if (m === 8) {
          p = A.jf(a.x);
          o = a.y;
          return o.length > 0 ? p + ("<" + A.fA(o, b) + ">") : p;
        }
        if (m === 10) return A.j7(a, b);
          ...
          if (q >= 48 && q <= 57) r = A.hW(r + 1, q, l, k);
            ...
            switch (q) {
              ...
              case 33:
                ...
                break;
              case 59:
                k.push(A.ad(a.u, a.e, k.pop()));
                break;
              case 94:
                k.push(A.i5(a.u, k.pop()));
                break;
              case 35:
                k.push(A.bf(a.u, 5, "#"));
                break;
      ...
      hV(a, b) {
        ...
        switch (o) {
          case -3:
            ...
            return;
          case -4:
            b.push(A.fb(p, b.pop(), s));
            return;
          default:
            throw A.b(A.br("Unexpected state under `()`: " + A.i(o)));
        }
      },
      hX(a, b) {
        var s = b.pop();
        ...
        throw A.b(A.br("Unexpected extended operation " + A.i(s)));
      },
      f3(a, b) {
        var s = b.splice(a.p);
        A.f7(a.u, a.e, s);
      ...
      ad(a, b, c) {
        if (typeof c == "string") return A.be(a, c, a.sEA);
      ...
      u(a, b, c, d, e) {
        ...
        if (q === 12) {
          ...
          return A.fu(a, b.x, c, d.x, e);
        }
        if (q === 11) {
          if (b === t.g) return !0;
          if (p) return !1;
          return A.fu(a, b, c, d, e);
        }
        if (s === 8) {
          if (q !== 8) return !1;
          return A.iW(a, b, c, d, e);
        }
        if (o && q === 10) return A.j_(a, b, c, d, e);
        return !1;
      },
      fu(a3, a4, a5, a6, a7) {
      ...
      iW(a, b, c, d, e) {
        ...
        for (; n !== m; ) {
          ...
          return A.fm(a, p, null, c, d.y, e);
        }
        return A.fm(a, b.y, null, c, d.y, e);
      },
      fm(a, b, c, d, e, f) {
        var s,
          r = b.length;
      ...
      aC(a) {
        var s = a.w,
          r = !0;
        if (!(a === t.P || a === t.T))
          if (!A.ai(a)) if (s !== 6) r = s === 7 && A.aC(a.x);
        return r;
      },
      ai(a) {
        var s = a.w;
      ...
      hR() {
        ...
        if (self.MutationObserver != null && self.document != null) {
          ...
          s.a = null;
          new self.MutationObserver(A.az(new A.cU(s), 1)).observe(r, {
            childList: true,
          });
          return new A.cT(s, r, q);
        } else if (self.setImmediate != null) return A.jj();
        return A.jk();
      },
      hS(a) {
        self.scheduleImmediate(A.az(new A.cV(a), 0));
      },
      hT(a) {
        self.setImmediate(A.az(new A.cW(a), 0));
      },
      hU(a) {
        A.i0(0, a);
      },
      ...
      fy(a) {
        return new A.bY(new A.v($.p, a.j("v<0>")), a.j("bY<0>"));
      },
      fr(a, b) {
        a.$2(0, null);
        b.b = !0;
      ...
      e9(a, b, c) {
        ...
        if (o === b) {
          ...
          b.a3(
            new A.H(
              new A.G(!0, o, null, "Cannot complete a future with itself"),
              s,
            ),
          );
          return;
        ...
        for (; !0; ) {
          ...
          if (l) {
            ...
            if ((f & 15) === 8) new A.d5(s, g, p).$0();
              ...
              if ((f & 1) !== 0) new A.d4(s, m).$0();
            } else if ((f & 2) !== 0) new A.d3(g, s).$0();
            if (j != null) $.p = j;
            f = s.c;
            if (f instanceof A.v) {
              r = s.a.$ti;
              r = r.j("X<2>").b(f) || !r.y[1].b(f);
            } else r = !1;
            if (r) {
              i = s.a.b;
              if ((f.a & 24) !== 0) {
      ...
      eM(a, b, c) {
        return A.jp(a, new A.aa(b.j("@<0>").C(c).j("aa<1,2>")));
      },
      e3(a, b) {
        return new A.aa(a.j("@<0>").C(b).j("aa<1,2>"));
      },
      hs(a) {
        var s,
          r = A.a3(a),
          q = new J.W(a, a.length, r.j("W<1>"));
        if (q.m()) {
          s = q.d;
      ...
      eE(a, b, c, d, e, f) {
        ...
        if (d + e !== f)
          throw A.b(A.y("Invalid base64 padding, '=' not at the end", a, b));
        if (e > 2)
          throw A.b(
            A.y("Invalid base64 padding, more than two '=' characters", a, b),
          );
      },
      it(a) {
        switch (a) {
      ...
      eT(a, b) {
        return new A.cu(a, A.eK(a, !1, b, !1, !1, ""));
      },
      eW(a, b, c) {
        var s = J.aE(b);
        if (!s.m()) return a;
      ...
      cn(a) {
        if (typeof a == "number" || A.en(a) || a == null) return J.al(a);
        if (typeof a == "string") return JSON.stringify(a);
        return A.eR(a);
      },
      hk(a, b) {
      ...
      V(a, b) {
        return new A.G(!1, null, b, a);
      },
      eD(a, b, c) {
        return new A.G(!0, a, b, c);
      },
      hF(a, b) {
      ...
      e_(a, b, c, d) {
        return new A.bx(b, !0, a, d, "Index out of range");
      },
      cJ(a) {
        return new A.b2(a);
      },
      ...
      hC(a, b, c, d) {
        ...
        if (B.h === c) {
          s = B.c.gp(a);
          b = J.U(b);
          return A.e8(A.a0(A.a0($.dY(), s), b));
        }
        if (B.h === d) {
          s = B.c.gp(a);
          b = J.U(b);
          c = J.U(c);
          return A.e8(A.a0(A.a0(A.a0($.dY(), s), b), c));
        }
        s = B.c.gp(a);
        b = J.U(b);
        c = J.U(c);
      ...
      bX(a4, a5, a6) {
        ...
        if (a6 >= s) {
          r =
            (((a4.charCodeAt(a5 + 4) ^ 58) * 3) |
              (a4.charCodeAt(a5) ^ 100) |
              (a4.charCodeAt(a5 + 1) ^ 97) |
              (a4.charCodeAt(a5 + 2) ^ 116) |
              (a4.charCodeAt(a5 + 3) ^ 97)) >>>
            0;
          if (r === 0)
            return A.f_(
              a5 > 0 || a6 < a6 ? B.a.i(a4, a5, a6) : a4,
              5,
              a3,
            ).gaZ();
          else if (r === 32) return A.f_(B.a.i(a4, s, a6), 0, a3).gaZ();
        }
        q = A.eO(8, 0, !1, t.S);
        q[0] = 0;
        p = a5 - 1;
        ...
        if (i) {
          ...
          if (!(n > o + 3)) {
            ...
            if (!(p && m + 1 === l)) {
              if (!B.a.t(a4, "\\", l))
                if (n > a5)
                  f = B.a.t(a4, "\\", n - 1) || B.a.t(a4, "\\", n - 2);
                else f = !1;
              else f = !0;
              if (!f) {
                if (!(k < a6 && k === l + 2 && B.a.t(a4, "..", l)))
                  f = k > l + 2 && B.a.t(a4, "/..", k - 3);
                else f = !0;
                if (!f)
                  if (o === a5 + 4) {
                    if (B.a.t(a4, "file", a5)) {
        ...
        if (i) {
          ...
          return new A.c9(a4, o, n, m, l, k, j, h);
        }
        if (h == null)
          if (o > a5) h = A.ik(a4, a5, o);
          else {
        ...
        if (n > a5) {
          ...
          s = m + 1;
          if (s < l) {
            a0 = A.eQ(B.a.i(a4, s, l), a3);
            d = A.ih(a0 == null ? A.ez(A.y("Invalid port", a4, s)) : a0, h);
          }
        } else {
          a = a3;
          b = "";
        }
        a1 = A.ig(a4, l, k, a3, h, a != null);
      ...
      hQ(a) {
        ...
        try {
          ...
          if (A.ak(r) instanceof A.L) return null;
          else throw r;
        }
      },
      f1(a) {
      ...
      hP(a, b, c) {
        ...
        for (s = b; !0; s = r) {
          if (s < c) {
            ...
            if (q === 46) {
              if (r - 1 === b) return new A.L(o, a, r);
              s = r;
              break;
            }
            return new A.L("Unexpected character", a, r - 1);
          }
          if (s - 1 === b) return new A.L(o, a, s);
          return new A.L("Missing '.' in IPvFuture address", a, s);
        }
        if (s === c)
          return new A.L(
        ...
        for (; !0; ) {
          ...
          return new A.L("Invalid IPvFuture address character", a, s);
        }
      },
      f0(a, b, a0) {
        var s,
      ...
      ih(a, b) {
        if (a != null && a === A.fd(b)) return null;
        return a;
      },
      ie(a, b, c, d) {
        var s, r, q, p, o, n, m, l;
        ...
        if (a.charCodeAt(b) === 91) {
          ...
          if (a.charCodeAt(s) !== 93)
            A.av(a, b, "Missing end `]` to match `[` in host");
          r = b + 1;
          q = "";
          if (a.charCodeAt(r) !== 118) {
            ...
            if (p < s) {
              o = p + 1;
              q = A.fi(a, B.a.t(a, "25", o) ? p + 3 : o, s, "%25");
            }
            s = p;
          }
          n = A.hO(a, r, s);
        ...
        for (l = b; l < c; ++l)
          if (a.charCodeAt(l) === 58) {
            ...
            if (s < c) {
              o = s + 1;
              q = A.fi(a, B.a.t(a, "25", o) ? s + 3 : o, c, "%25");
            } else q = "";
            A.f0(a, b, s);
        ...
        for (s = b, r = s, q = !0; s < c; ) {
          ...
          if (p === 37) {
            ...
            if (n) o = B.a.i(a, s, s + 3);
              ...
              A.av(a, s, "ZoneID should not contain % anymore");
            i.a = m + o;
            s += 3;
            r = s;
            q = !0;
      ...
      ik(a, b, c) {
        var s, r, q;
        if (b === c) return "";
        if (!A.ff(a.charCodeAt(b)))
          A.av(a, b, "Scheme not starting with alphabetic character");
        for (s = b, r = !1; s < c; ++s) {
          q = a.charCodeAt(s);
          if (!(q < 128 && (u.f.charCodeAt(q) & 8) !== 0))
            A.av(a, s, "Illegal scheme character");
          if (65 <= q && q <= 90) r = !0;
        }
        a = B.a.i(a, b, c);
      ...
      ef(a, b, c, d) {
        if (a != null) {
          if (d != null)
            throw A.b(A.V("Both query and queryParameters specified", null));
          return A.bj(a, b, c, 256, !0, !1);
        }
      ...
      eg(a, b, c) {
        ...
        if (q < 0 || p < 0) return "%";
        o = q * 16 + p;
        if (o < 127 && (u.f.charCodeAt(o) & 1) !== 0)
          return A.P(c && 65 <= o && 90 >= o ? (o | 32) >>> 0 : o);
      ...
      ic(a, b) {
        ...
        for (s = 0, r = 0; r < 2; ++r) {
          ...
          if (48 <= q && q <= 57) s = s * 16 + q - 48;
            ...
            else throw A.b(A.V("Invalid URL encoding", null));
          }
        }
        return s;
      },
      eh(a, b, c, d, e) {
        ...
        if (s)
          ...
          for (q = a.length, o = b; o < c; ++o) {
            r = a.charCodeAt(o);
            if (r > 127)
              throw A.b(A.V("Illegal percent encoding in URI", null));
            if (r === 37) {
              if (o + 3 > q) throw A.b(A.V("Truncated URI", null));
              p.push(A.ic(a, o + 1));
              o += 2;
      ...
      f_(a, b, c) {
        ...
        for (; p !== 44; ) {
          ...
          if (o >= 0) j.push(o);
            ...
            n = B.b.gZ(j);
            if (p !== 44 || r !== n + 7 || !B.a.t(a, "base64", n + 1))
              throw A.b(A.y("Expecting '='", a, r));
            break;
          }
        }
        j.push(r);
        ...
        if ((j.length & 1) === 1) a = B.o.bE(a, m, s);
          ...
          l = A.fh(a, m, s, 256, !0, !1);
          if (l != null) a = B.a.I(a, m, s, l);
        }
        return new A.cK(a, j, c);
      },
      fB(a, b, c, d, e) {
        var s, r, q;
        for (s = b; s < c; ++s) {
      ...
      c9: function c9(a, b, c, d, e, f, g, h) {
        var _ = this;
        _.a = a;
        _.b = b;
        _.c = c;
      ...
      a5(a) {
        ...
        if (typeof a == "function")
          throw A.b(A.V("Attempting to rewrap a JS function.", null));
        s = (function (b, c) {
          return function (d) {
      ...
      dU(a, b) {
        var s = new A.v($.p, b.j("v<0>")),
          r = new A.b3(s, b.j("b3<0>"));
      ...
      ju() {
        var s = v.G,
          r = s.document.getElementById("search-box"),
          q = s.document.getElementById("search-body"),
          p = s.document.getElementById("search-sidebar");
        A.dU(s.window.fetch($.bp() + "index.json"), t.m).aX(
          new A.dO(new A.dP(r, q, p), r, q, p),
          t.P,
        );
      },
      ea(a) {
      ...
      iF(a, b) {
        var s,
          ...
          m,
          l = v.G,
          k = l.document.createElement("div"),
          j = b.e;
        if (j == null) j = "";
        ...
        k.addEventListener("mousedown", A.a5(new A.dz()));
      ...
      el(a, b) {
        return A.jJ(a, A.eT(b, !1), new A.dB(), null);
      },
      dC: function dC() {},
      ...
      iN() {
        var s = v.G,
          r = s.document.getElementById("sidenav-left-toggle"),
          q = s.document.querySelector(".sidebar-offcanvas-left"),
          p = s.document.getElementById("overlay-under-drawer"),
          o = A.a5(new A.dD(q, p));
      ...
      iM() {
        ...
        A.fx(
          q,
          p.getAttribute("data-above-sidebar"),
          o.document.getElementById("dartdoc-sidebar-left-content"),
        );
        A.fx(
          q,
          p.getAttribute("data-below-sidebar"),
          o.document.getElementById("dartdoc-sidebar-right"),
        );
      },
      fx(a, b, c) {
      ...
      jK(a) {
        throw A.x(A.eL(a), new Error());
      },
      bo() {
        throw A.x(A.eL(""), new Error());
      },
      hu(a, b) {
        var s, r, q, p, o, n;
        ...
        s = b.split(".");
        r = v.G;
        for (q = s.length, p = t.A, o = 0; o < q; ++o) {
          n = s[o];
          r = p.a(r[n]);
          if (r == null) return !1;
        }
  ...
  J.o.prototype = {
    W(a, b) {
      return new A.N(a, A.a3(a).j("@<1>").C(b).j("N<1,2>"));
    },
    X(a) {
    ...
    bx(a, b, c) {
      ...
      for (s = b, r = 0; r < q; ++r) {
        s = c.$2(s, a[r]);
        if (a.length !== q) throw A.b(A.am(a));
      }
      return s;
    },
    by(a, b, c) {
    ...
    gv(a) {
      return new J.W(a, a.length, A.a3(a).j("W<1>"));
    },
    gp(a) {
      return A.bQ(a);
    },
  ...
  J.a9.prototype = {
    ...
    i(a, b, c) {
      return a.substring(b, A.bR(b, c, a.length));
    },
    K(a, b) {
  ...
  A.a1.prototype = {
    gv(a) {
      return new A.bs(J.aE(this.gM()), A.T(this).j("bs<1,2>"));
    },
    gl(a) {
      return J.cg(this.gM());
    },
    D(a, b) {
      return A.T(this).y[1].a(J.eC(this.gM(), b));
    },
    h(a) {
      return J.al(this.gM());
    },
  ...
  A.b4.prototype = {
    k(a, b) {
      return this.$ti.y[1].a(J.h5(this.a, b));
    },
    $ic: 1,
    $if: 1,
  };
  ...
  A.aF.prototype = {
    ...
    gp(a) {
      return (A.fM(this.a) ^ A.bQ(this.$_target)) >>> 0;
    },
    h(a) {
      return (
        "Closure '" +
  ...
  A.aa.prototype = {
    ...
    gP() {
      return new A.ab(this, A.T(this).j("ab<1>"));
    },
    O(a) {
      var s = this.b;
      if (s == null) return !1;
    ...
    A(a, b, c) {
      ...
      if (typeof b == "string") {
        s = m.b;
        m.ap(s == null ? (m.b = m.a8()) : s, b, c);
      } else if (typeof b == "number" && (b & 0x3fffffff) === b) {
        r = m.c;
        m.ap(r == null ? (m.c = m.a8()) : r, b, c);
      } else {
        q = m.d;
  ...
  A.c7.prototype = {
    ...
    gp(a) {
      return A.hC(this.$s, this.a, this.b, B.h);
    },
  };
  A.cu.prototype = {
    h(a) {
  ...
  A.J.prototype = {
    j(a) {
      return A.bg(v.typeUniverse, this, a);
    },
    C(a) {
      return A.fc(v.typeUniverse, this, a);
    },
  };
  A.c2.prototype = {};
  A.dk.prototype = {
  ...
  A.di.prototype = {
    b8(a, b) {
      if (self.setTimeout != null)
        self.setTimeout(A.az(new A.dj(this, b), 0), a);
  ...
  A.v.prototype = {
    ao(a, b, c) {
      var s,
        ...
        q = $.p;
      if (q === B.d) {
        if (b != null && !t.Q.b(b) && !t.v.b(b))
          throw A.b(A.eD(b, "onError", u.c));
      } else if (b != null) b = A.j8(b, q);
      s = new A.v(q, c.j("v<0>"));
      r = b == null ? 1 : 3;
    ...
    a2(a) {
      ...
      if (r <= 3) {
        ...
        A.cd(null, null, s.b, new A.cZ(s, a));
      }
    },
    aA(a) {
      var s,
  ...
  A.e.prototype = {
    gv(a) {
      return new A.an(a, this.gl(a), A.aB(a).j("an<e.E>"));
    },
    D(a, b) {
      return this.k(a, b);
    },
  ...
  A.O.prototype = {
    F(a, b) {
      var s, r, q, p;
      for (s = this.gP(), s = s.gv(s), r = A.T(this).j("O.V"); s.m(); ) {
        q = s.gn();
        p = this.k(0, q);
  ...
  A.ap.prototype = {
    ...
    D(a, b) {
      ...
      throw A.b(A.e_(b, b - r, this, "index"));
    },
    $ic: 1,
  };
  A.bh.prototype = {};
  A.c3.prototype = {
    ...
    gP() {
      if (this.b == null) {
        var s = this.c;
        return new A.ab(s, A.T(s).j("ab<1>"));
      }
  ...
  A.c4.prototype = {
    ...
    gv(a) {
      ...
      if (s.b == null) {
        ...
        s = s.L();
        s = new J.W(s, s.length, A.a3(s).j("W<1>"));
      }
      return s;
    },
  };
  ...
  A.cQ.prototype = {
    H(a) {
      return new A.dq(this.a).be(a, 0, null, !0);
    },
  };
  A.dq.prototype = {
    be(a, b, c, d) {
  ...
  A.b_.prototype = {
    ...
    ga6() {
      var s,
        ...
        q = this.f;
      if (r == null)
        s = q != null ? ": Not less than or equal to " + A.i(q) : "";
  ...
  A.r.prototype = {
    W(a, b) {
      return A.hc(this, A.T(this).j("r.E"), b);
    },
    gl(a) {
      var s,
        r = this.gv(this);
  ...
  A.cO.prototype = {
    $2(a, b) {
      var s,
        ...
        p = B.a.aP(b, "=");
      if (p === -1) {
        if (b !== "") a.A(0, A.eh(b, 0, b.length, this.a, !0), "");
      } else if (p !== 0) {
        s = B.a.i(b, 0, p);
        r = B.a.K(b, p + 1);
        q = this.a;
        a.A(0, A.eh(s, 0, s.length, q, !0), A.eh(r, 0, r.length, q, !0));
      }
      return a;
    },
    $S: 17,
  ...
  A.cK.prototype = {
    gaZ() {
      ...
      if (m == null) {
        ...
        q = m.length;
        if (r >= 0) {
          p = A.bj(m, r + 1, q, 256, !1, !1);
          q = r;
        } else p = n;
        m = o.c = new A.c0("data", "", n, n, A.bj(m, s, q, 128, !1, !1), p, n);
      }
      return m;
    },
    h(a) {
  ...
  A.dW.prototype = {
    $1(a) {
      if (a == null) return this.a.aH(new A.cB(a === undefined));
      return this.a.aH(a);
    },
    $S: 2,
  };
  ...
  A.cq.prototype = {
    aI(a) {
      ...
      r = A.k([], t.r);
      for (
        q = this.a, p = q.length, o = s.length > 1, n = "dart:" + s, m = 0;
        m < q.length;
        q.length === p || (0, A.dX)(q), ++m
      ) {
        l = q[m];
        k = new A.ct(r, l);
        j = l.a.toLowerCase();
        ...
        if (j === s || i === s || j === n) k.$1(B.ag);
          ...
          if (B.a.u(j, s) || B.a.u(i, s)) k.$1(B.ah);
  ...
  A.dC.prototype = {
    $0() {
      var s,
        r = v.G.document.body;
      if (r == null) return "";
      if (J.F(r.getAttribute("data-using-base-href"), "false")) {
  ...
  A.dP.prototype = {
    $0() {
      A.jF("Could not activate search functionality.");
      var s = this.a;
  ...
  A.dO.prototype = {
    ...
    b1(a) {
      var s = 0,
        ...
        h,
        g;
      var $async$$1 = A.fF(function (b, c) {
        if (b === 1) return A.fp(c, r);
        while (true)
          switch (s) {
            case 0:
              if (!J.F(a.status, 200)) {
  ...
  A.dc.prototype = {
    ...
    ah(a) {
      ...
      r.appendChild(p.gG());
      p.b3(a);
      if (J.h8(s.window.location.href, "search.html")) {
        q = p.b.gal().k(0, "q");
        if (q == null) return;
        q = B.j.H(q);
        $.er = $.dG;
    ...
    b4(a) {
      var s,
        ...
        q,
        p = v.G,
        o = p.document.getElementById("dartdoc-main-content");
      if (o == null) return;
      o.textContent = "";
      ...
      o.appendChild(s);
      if ($.a4.a !== 0)
        for (p = new A.aS($.a4, $.a4.r, $.a4.e); p.m(); ) o.appendChild(p.d);
      else {
        s = p.document.createElement("div");
        s.classList.add("search-summary");
        s.innerHTML =
          'There was not a match for "' +
          a +
          '". Want to try searching from additional Dart-related sites? ';
        r = A.bX(
    ...
    aY(a, b, c) {
      ...
      for (q = 0; q < b.length; b.length === r || (0, A.dX)(b), ++q)
        s.push(A.iF(a, b[q]));
      for (r = J.aE(c ? new A.aT($.a4, A.T($.a4).j("aT<2>")) : s); r.m(); ) {
        p = r.gn();
        o.gR().appendChild(p);
      }
      o.x = b;
      o.y = -1;
      if (o.gR().hasChildNodes()) {
        r = o.gG();
    ...
    bB(a, b) {
      return this.ae(a, !1, b);
    },
    aK(a) {
      return this.ae(a, !1, !1);
    },
    bA(a, b) {
      return this.ae(a, b, !1);
    },
    aF(a) {
      var s,
        r = this;
    ...
    $1(a) {
      ...
      if (J.F(a.code, "Enter")) {
        ...
        if (r !== -1) {
          ...
          p = B.j.H(s.r);
          o = A.bX($.bp() + "search.html", 0, null).am(
            A.eM(["q", p], t.N, t.z),
          );
      ...
      n = r.length - 1;
      m = s.y;
      if (J.F(a.code, "ArrowUp")) {
        l = s.y;
        if (l === -1) s.y = n;
        else s.y = l - 1;
      } else if (J.F(a.code, "ArrowDown")) {
        l = s.y;
        if (l === n) s.y = -1;
        else s.y = l + 1;
      } else if (J.F(a.code, "Escape")) s.aF(e.b);
      else {
        if (s.f != null) {
          s.f = null;
          s.aK(e.b.value);
  ...
  A.dA.prototype = {
    $1(a) {
      var s = this.a.e;
      if (s != null) {
        v.G.window.location.assign($.bp() + s);
        a.preventDefault();
      }
    },
    $S: 1,
          ...
          switch (s) {
            case 0:
              if (!J.F(a.status, 200)) {
                ...
                o.text =
                  "Failed to load sidebar. Visit dart.dev for help troubleshooting.";
                p.a.appendChild(o);
                s = 1;
                break;
              }
  ...
  var v = {
    ...
    types: [
      ...
      "~(d,d?)",
      "~(B)",
      "a(+item,matchPosition(w,B),+item,matchPosition(w,B))",
      "w(+item,matchPosition(w,B))",
      "d()",
      "d(cA)",
      "~(bn)",
      "a(@,@)",
  ...
  var t = (function rtii() {
    ...
    return {
      ...
      j: s("f<@>"),
      a: s("z<d,@>"),
      V: s("ac<+item,matchPosition(w,B),w>"),
      P: s("t"),
      K: s("j"),
      L: s("jQ"),
      d: s("+()"),
